...
(**)
(*Hamiltonian4TBpack::usage="Constructs tight-binding Hamiltonian from the atomic coordinates of the unit cell, nearest-neighbour distances and hopping integrals, etc.";*)
(**)
(*ElectronicStructure4TBpack::usage="Calculates electronic energy levels or band structure for the specified monoelement unit cell, translation vectors and tight-binding parameters, etc.";*)
(**)
(**)
(**)
(**)
